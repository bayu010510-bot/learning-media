...
DATA_MATERI = {
    ...
    "Bahasa Indonesia": {
        "Bab 1: Teks Laporan Hasil Observasi": {
            "sub_bab": ["1.1 Struktur Teks Observasi", "1.2 Kaidah Kebahasaan"],
            "rangkuman": "• **Pengertian**: Teks yang berisi penjabaran umum melaporkan sesuatu berdasarkan hasil pengamatan langsung secara objektif.\n• **Struktur**: Pernyataan Umum ➔ Deskripsi Bagian ➔ Deskripsi Manfaat."
        },
        "Bab 2: Proposal dan Karya Ilmiah": {
            "sub_bab": ["2.1 Merancang Sistematika Proposal", "2.2 Format Karya Ilmiah"],
            "rangkuman": "• **Proposal**: Rencana kerja resmi yang disusun secara sistematis untuk diajukan mendapatkan persetujuan.\n• **Karya Ilmiah**: Laporan tertulis yang memaparkan hasil penelitian sesuai kaidah keilmuan yang objektif."
        }
    }
}
